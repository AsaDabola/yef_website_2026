...
const builtInPages: { route: string; title: string }[] = [
  ...
  { route: "get-involved/leadership-training/apply", title: "Apply for Leadership Training" },
  { route: "get-involved/volunteer", title: "Volunteer with YEF" },
  { route: "get-involved/volunteering", title: "Volunteering" },
  { route: "get-involved/bible-studies", title: "Bible Studies" },
  { route: "get-involved/discipleship", title: "Discipleship Training" },
  { route: "get-involved/short-term-mission", title: "Short-term Mission" },
  { route: "get-involved/short-term-mission/apply", title: "Apply for Short-term Mission" },
  { route: "get-involved/summer-training", title: "Summer Training" },
