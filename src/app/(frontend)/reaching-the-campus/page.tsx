      ...
      <main>
        ...
        <section className="mx-auto max-w-[1440px] px-6 py-16 lg:px-12">
          ...
          <p className="mx-auto mt-8 max-w-[1109px] text-center font-semibold text-[26px] text-[#4b5565] leading-[38px] tracking-[-0.8px] lg:text-[38px] lg:leading-[50px]">
            ...
            awakening. Again and again, God has called young men and women who
            were willing to dedicate the strength, passion, and years of their
            youth to His Kingdom.
          </p>
            ...
            <TextPhotoBlock
              ...
              body={
                <>
                  ...
                  the founder of the China Inland Mission, was only 21 years
                  old when he first sailed for China. His willingness to
                  answer God&rsquo;s call as a young man eventually
          ...
          <div className="mt-16">
            <TextPhotoBlock
              ...
              alt="A student smiling outside on campus"
              body={
                <>
                  <span className="font-bold">John Calvin</span> was also
                  still a young man when he published the first edition of his
                  influential{" "}
                  <em>Institutes of the Christian Religion</em> at the age of
                  26. The work would continue to develop throughout his life
                  and profoundly influence generations of Christian theology,
          ...
          <p className="mx-auto mt-24 max-w-[695px] text-center font-semibold text-[24px] text-[#4b5565] leading-[38px] tracking-[-0.8px] lg:text-[30.3px] lg:leading-[50px]">
            Many of those who first followed Jesus were also young people who
            left behind their ordinary lives to become His disciples. Jesus
            taught them, corrected them, walked with them, and eventually
            entrusted them with the responsibility of carrying the gospel into
            the world.
          </p>
          ...
          <div className="mx-auto mt-16 max-w-[849px] space-y-[30px] font-medium text-[19px] text-[#4b5565] leading-[30px]">
            <p>
              ...
              preparation for serving God someday. Young people can be used by
              God now.
            </p>
            <p>
            ...
            <p>
              ...
              Universities gather together a generation that still has much of
              its life ahead of it. If students can encounter Christ during
              these formative years and learn to dedicate their gifts,
              education, ambitions, and future to God, their influence for the
              gospel can continue for decades.
            </p>
            <p>
              YEF therefore believes that reaching university students is also
              an investment in the future of world mission. We desire to see a
              new generation arise&mdash;not simply as attendees of Christian
              gatherings, but as disciples, evangelists, Bible teachers,
              leaders, and missionaries who are willing to say:
            </p>
          </div>
          ...
          <p className="mx-auto mt-16 max-w-[695px] text-center font-semibold text-[24px] text-black leading-[38px] tracking-[-0.8px] lg:text-[30.3px] lg:leading-[50px]">
            ...
            <span className="block">&mdash; Isaiah 6:8</span>
          </p>
